...
import 'kleur/colors';
import { $ as $$Layout } from '../../chunks/Layout_D9aETZa2.mjs';
import { $ as $$Modal } from '../../chunks/Modal_BO3RelAb.mjs';
export { renderers } from '../../renderers.mjs';

const $$History = createComponent(async ($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Post History // PostPulsar" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="container py-12"> <div class="flex items-center justify-between"> <h1 class="text-3xl font-bold uppercase">// Post History</h1> <a href="/app" class="font-mono text-sm uppercase text-foreground/70 hover:text-primary">&lt; Back to Dashboard</a> </div> <p class="mt-2 text-foreground/70">Manage your previously generated posts. You can store up to 20 posts.</p> <div id="history-container" class="mt-8 space-y-6"> <!-- Posts will be loaded here by client-side script --> <div class="border border-dashed border-border p-8 text-center"> <p class="font-mono text-foreground/70">Loading history...</p> </div> </div> </main> ${renderComponent($$result2, "Modal", $$Modal, {})} ${renderScript($$result2, "/home/enio/projetos/post-pulsar/src/pages/app/history.astro?astro&type=script&index=0&lang.ts")} ` })}`;
