...
serve(async (req: Request) => {
  ...
  try {
    ...
    console.log(
      "--- IMPORTANT: Use this exact URL in your new Meta App Dashboard for Threads ---",
    );
    ...
    const scopes = ["threads_basic", "threads_content_publish"].join(","); // Comma-separated, like the Instagram integration
    ...
    console.error("Error in threads-auth-start:", errorMessage);
