...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (!FACEBOOK_CLIENT_ID) {
      console.error("CRITICAL: FACEBOOK_CLIENT_ID environment variable not set or not accessible.");
      throw new Error("Server configuration error: Missing Facebook Client ID.");
    }
    ...
    console.error("Error in facebook-auth-start:", error);
