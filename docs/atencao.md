...
-   **A Solução:** A correção imediata e segura foi tratar o dado no cliente. Modificamos a linha de código que define a variável do plano para "limpar" a string, removendo as aspas extras: `# Atenção: Lições Aprendidas com Integrações OAuth
